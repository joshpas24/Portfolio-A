          ...
          <div className="rounded-3xl p-10 w-full md:w-fit bg-black/65 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex flex-col gap-6 justify-center items-center md:items-start">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://docs.google.com/document/d/1FAU2p8rl9nKo99RE8XkXtuzGTlOfC_q8I6qTc5-4g2s/export?format=pdf" target="_blank" title="Resume Download" className="p-3 w-12 h-12 border rounded-full text-xl text-white flex items-center justify-center hover:bg-gray-500/65">
